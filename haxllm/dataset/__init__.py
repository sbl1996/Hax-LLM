...
def create_dataset(name, tokenizer, max_len=128, eval_size=None, batch_size=128, eval_batch_size=None,
    ...
    if name == 'imdb':
        return create_imdb_dataset(tokenizer, max_len, eval_size, batch_size, eval_batch_size, seed, with_test, sub_ratio)
    elif name == 'sst2':
        return create_sst2_dataset(tokenizer, max_len, eval_size, batch_size, eval_batch_size, seed, with_test, sub_ratio)
    else:
